...
- [x] Переработка визуальной части всего приложения в подтверждённом светлом
  нейтральном направлении.
- [x] Быстрое создание операции.
- [ ] Шаблоны операций.
...
# После 0.4.0 — эксплуатация и надёжность
