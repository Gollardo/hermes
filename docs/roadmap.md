...
- [ ] Определение состояния неинициализированного приложения.
- [ ] Экран первоначальной настройки.
- [ ] Создание мастер-пароля.
- [ ] Выбор основной валюты.
- [ ] Выбор часового пояса.
- [ ] Запрет повторной первоначальной настройки после инициализации.
...
- [ ] Защита API, кроме setup, login и healthcheck.
- [ ] Ограничение частых неудачных попыток входа.

## Настройки

- [ ] Просмотр настроек приложения.
- [ ] Изменение часового пояса.
- [ ] Изменение основной валюты до появления финансовых данных.
- [ ] Смена мастер-пароля.

## Критерии релиза

- Новый пользователь может развернуть приложение и пройти первоначальную настройку.
- Неавторизованный пользователь не получает доступ к финансовым данным и защищённым API.
- Сессия корректно создаётся, проверяется и завершается.
- Проверен запуск на чистой базе данных.
- Проверена миграция уже инициализированной базы.
...
- [ ] Создание счёта.
- [ ] Типы счетов: `cash`, `debit`, `savings`.
- [ ] Название и описание счёта.
- [ ] Начальный остаток через финансовую операцию корректировки.
- [ ] Просмотр списка счетов.
- [ ] Просмотр текущего остатка.
- [ ] Редактирование счёта.
- [ ] Архивирование и восстановление счёта.
- [ ] Запрет некорректного удаления счёта с историей операций.
...
- [ ] Корректная работа операций с архивными категориями.

## Критерии релиза

- Пользователь может создать структуру счетов и категорий.
- Начальный остаток не хранится как произвольно изменяемое поле.
- Архивирование не разрушает финансовую историю.
