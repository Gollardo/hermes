...
**0.2.0 — реализуется первый срез отчётности и ускорения ежедневного ввода.**

Следующий шаг: production-like container build и owner acceptance версии
`0.2.0` на реальных данных.
...
- Для текущего `0.2.0` diff пройдены Ruff, backend format, mypy, Angular lint, Prettier,
