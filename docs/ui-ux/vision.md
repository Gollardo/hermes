...
Документ сочетает owner-confirmed продуктовое направление от 2026-08-02 и
гипотезы, которые ещё нужно проверить прототипами. Это не утверждённый дизайн и
не детальная спецификация реализации.
...
и «куда ушла большая часть денег?». Общая сумма, долги/обязательства и тренды
дают контекст, но не конкурируют с главным ответом.
