...
Основной UX-фокус подтверждён владельцем 2026-08-02. В `0.1.0-alpha.3`
реализован первый адаптивный inline-composer рядом с журналом. Он использует
...
Предпочтение modal остаётся гипотезой для следующей UX-итерации, а не описанием
текущего экрана.
