...
Реализованное направление `0.1.0-alpha.4`. Визуальная система остаётся
предварительной, а posting, rounding и archive rules зафиксированы в ADR 0002
как alpha-политика.
...
показывает точный доступный процент для создаваемого или редактируемого фонда.
Нельзя молча нормализовать значения.
