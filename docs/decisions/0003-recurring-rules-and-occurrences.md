...
date is the recurrence anchor. An optional end date is inclusive. Monthly rules
accept only start days 1–28, and yearly rules reject 29 February, so generation
never invents a policy for a missing calendar day.
